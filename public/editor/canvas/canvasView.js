class CanvasView {
    ...
    takeScreenshot(w, h, sceneID, actorList, upload) {
        ...
        frameTexture.tint = PIXI.utils.string2hex(this.gameProperties.backgroundColor);
    ...
    update(actorList, gameProperties) {
        ...
        this.appRenderer.backgroundColor = PIXI.utils.string2hex(this.gameProperties.backgroundColor);
